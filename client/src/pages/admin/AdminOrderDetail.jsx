...
function SectionCard({ title, icon, children, className = '' }) {
  return (
    <div className={`card mb-4 shadow-card-md ${className}`}>
    ...
    <li className="flex gap-4">
      ...
      <div className="pb-5 min-w-0">
        ...
        <p className="mt-1 text-xs text-gray-400">
          ...
          <span className="capitalize bg-surface-100 rounded-md px-1.5 py-0.5 font-medium">{entry.actorRole}</span>
        </p>
      </div>
    </li>
  );
...
export default function AdminOrderDetail() {
  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      {/* Assignment panel */}
      <div className="card mb-4 bg-gradient-to-br from-brand-50/50 to-white border-brand-200 shadow-card-md">
      ...
      {/* Override status */}
      <div className="card mb-4 bg-gradient-to-br from-purple-50/40 to-white border-purple-200 shadow-card-md">
